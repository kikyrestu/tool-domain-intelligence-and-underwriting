"""Quick test: Playwright+Stealth on Cloudflare-protected site."""
import asyncio
import re
...
async def main():
    ...
    async with Stealth().use_async(async_playwright()) as pw:
        ...
        chall = bool(re.search(r"just a moment|one moment|please wait\.\.\.?|ddos protection|challenge-platform|turnstile", html, re.I))
